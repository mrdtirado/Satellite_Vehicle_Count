...
D = {}
labels = {}
with open('/home/ubuntu/satellite_vehicle_count/xview_class_labels.txt') as f:
    for row in csv.reader(f):
        labels[int(row[0].split(":")[0])] = row[0].split(":")[1]

with open('/home/ubuntu/satellite_vehicle_count/xView_train.geojson') as f:
    data = json.load(f)
    ...
    for k in keys:
        ...
        for (label, (startX, startY, endX, endY)) in D[k]:
            ...
            cv2.rectangle(image, (startX, startY), (endX, endY),
                           (0, 255, 0), 2)
            cv2.imwrite('/home/ubuntu/satellite_vehicle_count/test_images/{}'.format(
                    filename), image)
